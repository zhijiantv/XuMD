...
<p style="font-size:12px;color:{{token.subTextColor}};text-align:center;margin:0 0 24px;">
  ...
  <span style="font-size:12px;color:{{token.primary}};font-weight:700;flex-shrink:0;margin-top:2px;"><span leaf="">{{index}}.</span></span>
  ...
  <p style="margin:0;">
    <span style="font-size:14px;color:{{token.textColor}};line-height:1.8;">
      ...
      divider: `<section style="padding:0 10px;margin:48px 0;">
  <section style="height:1px;background:linear-gradient(to right,{{token.primary}},transparent);">
    <span leaf=""><br></span>
  </section>
</section>`,
