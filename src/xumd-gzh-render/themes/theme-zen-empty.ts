...
<p style="font-size:12px;color:{{token.subTextColor}};text-align:center;margin:0 0 28px;">
  ...
  <table style="width:100%;border-collapse:collapse;font-size:13px;">
    ...
    <tbody>{{rows}}</tbody>
      ...
      orderedListItem: `<section style="display:flex;align-items:flex-start;gap:14px;margin-bottom:14px;">
  <span style="font-size:12px;color:{{token.primary}};font-weight:600;flex-shrink:0;margin-top:2px;font-family:'Noto Serif SC',Georgia,serif;"><span leaf="">{{index}}</span></span>
  ...
  <p style="margin:0;">
    <span style="font-size:14px;color:{{token.textColor}};line-height:1.9;">
      ...
      divider: `<section style="padding:0 16px;margin:64px 0;text-align:center;background:#FFFFFF;">
  <section style="display:inline-block;width:40px;height:1px;background:{{token.primary}};">
    <span leaf=""><br></span>
  </section>
</section>`,
