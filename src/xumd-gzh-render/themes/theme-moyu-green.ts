...
<p style="font-size:12px;color:{{token.subTextColor}};text-align:center;margin:0 0 24px;">
  ...
  <table style="width:100%;border-collapse:collapse;font-size:13px;">
    ...
    <tbody>{{rows}}</tbody>
      ...
      // 有序列表
      orderedListItem: `<section style="margin-bottom:12px;"><span style="display:inline-block;width:22px;height:22px;line-height:22px;text-align:center;font-size:11px;font-weight:700;color:#fff;background:{{token.primary}};border-radius:50%;margin-right:10px;vertical-align:top;"><span leaf="">{{index}}</span></span><span style="display:inline-block;font-size:14px;color:{{token.textColor}};line-height:1.9;vertical-align:top;"><span leaf="">{{content}}</span></span></section>`,
  ...
  <div style="margin:0 0 6px;">
    <span style="display:inline-block;font-size:13px;font-weight:700;color:{{token.primary}};background:{{token.primaryBg}};padding:3px 10px;border-radius:999px;">
      ...
      // 分割线（多种样式，颜色跟随主题）
      dividerSolid: `<section style="padding:0 20px;margin:36px 0;">
  <section style="border-top:1px solid {{token.dividerColor}};">
    <span leaf=""><br></span>
  </section>
</section>`,
      dividerDashed: `<section style="padding:0 20px;margin:36px 0;">
  <section style="border-top:1px dashed {{token.dividerColor}};">
    <span leaf=""><br></span>
  </section>
</section>`,
      dividerDouble: `<section style="padding:0 20px;margin:36px 0;">
  <section style="border-top:1px solid {{token.dividerColor}};border-bottom:1px solid {{token.dividerColor}};height:3px;">
    <span leaf=""><br></span>
  </section>
</section>`,
      dividerDot: `<section style="padding:0 20px;margin:36px 0;text-align:center;">
  ...
  <span style="display:inline-block;width:32%;border-top:1px solid {{token.dividerColor}};vertical-align:middle;"><span leaf=""><br></span></span>
      ...
      dividerDiamond: `<section style="padding:0 20px;margin:36px 0;text-align:center;">
  <span style="display:inline-block;width:32%;border-top:1px solid {{token.dividerColor}};vertical-align:middle;"><span leaf=""><br></span></span>
  <span style="display:inline-block;color:{{token.primary}};font-size:12px;margin:0 12px;vertical-align:middle;"><span leaf="">◆</span></span>
  <span style="display:inline-block;width:32%;border-top:1px solid {{token.dividerColor}};vertical-align:middle;"><span leaf=""><br></span></span>
</section>`,
      dividerText: `<section style="padding:0 20px;margin:36px 0;text-align:center;">
  ...
  <span style="display:inline-block;width:22%;border-top:1px solid {{token.dividerColor}};vertical-align:middle;"><span leaf=""><br></span></span>
      ...
      // 分割线（整条线带主题主色）
      dividerPrimary: `<section style="padding:0 20px;margin:36px 0;">
  <section style="border-top:2px solid {{token.primary}};">
    <span leaf=""><br></span>
  </section>
</section>`,
      dividerPrimaryBold: `<section style="padding:0 20px;margin:36px 0;">
  <section style="border-top:4px solid {{token.primary}};">
    <span leaf=""><br></span>
  </section>
</section>`,
      dividerPrimaryGradient: `<section style="padding:0 20px;margin:36px 0;text-align:center;">
  <span style="display:inline-block;width:60%;height:3px;border-radius:2px;background:linear-gradient(to right,{{token.primary}},rgba(0,0,0,0),{{token.primary}});vertical-align:middle;"><span leaf=""><br></span></span>
      ...
      dividerPrimaryDotted: `<section style="padding:0 20px;margin:36px 0;text-align:center;">
