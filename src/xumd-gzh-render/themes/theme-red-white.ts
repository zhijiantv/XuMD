...
<p style="font-size:12px;color:{{token.subTextColor}};text-align:center;margin:0 0 24px;">
  ...
  <p style="margin:0 0 6px;">
    <span style="display:inline-block;font-size:14px;color:{{token.textColor}};line-height:1.8;">
      ...
      // 分割线
      divider: `<section style="padding:0 10px;margin:40px 0;">
  <section style="height:1px;background:linear-gradient(to right,transparent,{{token.primaryLight}},{{token.primary}},{{token.primaryLight}},transparent);">
    <span leaf=""><br></span>
  </section>
</section>`,
